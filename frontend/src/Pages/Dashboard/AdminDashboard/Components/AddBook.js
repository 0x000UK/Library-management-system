...
function AddBook() {
    ...
    return (
        <div>
            ...
            <label className="addbook-form-label" htmlFor="bookImage">Book Image Link<span className="required-field">*</span></label><br />
            <input className="addbook-form-input" type="text" name="bookImage" value={bookImage} onChange={(e) => { setBookImage(e.target.value) }} required></input><br />
                ...
                <label className="addbook-form-label" htmlFor="year">Year</label><br />
                <input className="addbook-form-input" type="number" name="year" value={year} onChange={(e) => { setYear(e.target.value) }}></input><br />
